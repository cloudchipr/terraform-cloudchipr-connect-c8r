...
| <a name="requirement_archive"></a> [archive](#requirement_archive)       | >= 2.4.2 |
...
| <a name="provider_aws"></a> [aws](#provider_aws)             | 6.46.0  |
...
| [aws_iam_role_policy.c8r_stack](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy)                               | resource    |
| [aws_iam_role_policy.c8r_stack_lambda_basic](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy)                  | resource    |
| [aws_iam_role_policy.c8r_stack_lambda_cost](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy)                   | resource    |
| [aws_iam_role_policy.c8r_stack_self_inspect](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy)                  | resource    |
...
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------ | :------: |
| <a name="input_C8R_API_ENDPOINT"></a> [C8R_API_ENDPOINT](#input_C8R_API_ENDPOINT) | API Endpoint used to verify account setup process.                                                      | `string` | `"https://api-bff.cloudchipr.com/providers/aws/account-attempts/"` |    no    |
| <a name="input_access_level"></a> [access_level](#input_access_level)             | Access level user wants to provide to Cloudchipr.                                                       | `string` | `"read_write"`                                                     |    no    |
| <a name="input_data"></a> [data](#input_data)                                     | Takes as input the source Account ID and Unique Key as External ID for cross-account trust relationship | `string` | n/a                                                                |   yes    |

## Outputs

| Name                                                                    | Description                                    |
| ----------------------------------------------------------------------- | ---------------------------------------------- |
| <a name="output_result_entry"></a> [result_entry](#output_result_entry) | Response from Cloudchipr API Callback function |
